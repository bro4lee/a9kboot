...
#
# *********
# This script shutdown all listed interfaces in Card 2 of the A9K Chassis
# *********
#
...
set output_msg "EEM shut-card-2.tcl kicks in"
...
set output_msg "delay 5s in EEM shut-card-2.tcl ..."
action_syslog priority info msg $output_msg
after 5000

set output_msg "Now EEM shut-card-2.tcl shutdown all specified interfaces in card 2 ..."
action_syslog priority info msg $output_msg
...
action_syslog priority emergencies msg "End of EEM shut-card-2.tcl execution "
action_syslog priority info msg $output_msg
